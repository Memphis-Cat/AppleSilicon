...
cat > "$PROFILE" <<'EOF'
APPLESILICON_QEMU_BIN="${APPLESILICON_QEMU_BIN:-${ROOT_DIR}/.build/runtime-inferno/qemu-system-aarch64}"

APPLESILICON_VMAPPLE_ACCEL="${APPLESILICON_VMAPPLE_ACCEL:-tcg}"
APPLESILICON_VMAPPLE_CPU_PROFILE="${APPLESILICON_VMAPPLE_CPU_PROFILE:-apple-gxf}"
APPLESILICON_VMAPPLE_SMP="${APPLESILICON_VMAPPLE_SMP:-4}"
APPLESILICON_VMAPPLE_RAM="${APPLESILICON_VMAPPLE_RAM:-4G}"

APPLESILICON_VMAPPLE_UUID="${APPLESILICON_VMAPPLE_UUID:-0x13579bdf2468ace0}"
APPLESILICON_VMAPPLE_MACHINE_IDENTITY="${APPLESILICON_VMAPPLE_MACHINE_IDENTITY:-${ROOT_DIR}/.build/runtime/machine-identity-runtime.json}"
APPLESILICON_VMAPPLE_FIRMWARE="${APPLESILICON_VMAPPLE_FIRMWARE:-${ROOT_DIR}/.build/runtime/realboot/AVPBooter.vmapple2.bin}"

APPLESILICON_P1_07_QEMU_SEED="${APPLESILICON_P1_07_QEMU_SEED:-135792468}"
EOF
